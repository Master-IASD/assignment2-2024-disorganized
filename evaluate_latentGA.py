...
real_images_path = "samples_latentGA/real_images"
fake_images_path = "samples_latentGA/fake_images"
...
if __name__ == '__main__':
    ...
    # Load generator and latent reweighting models
    ...
    from model import Latent_reweighting
    from utils import load_model_w
